...
@Component({
    selector: 'app-destinations-in-australia-page',
    imports: [RouterLink, PageBanner, NgStyle],
    templateUrl: './destinations-in-australia-page.html',
    styleUrl: './destinations-in-australia-page.scss',
})
export class DestinationsInAustraliaPage {
