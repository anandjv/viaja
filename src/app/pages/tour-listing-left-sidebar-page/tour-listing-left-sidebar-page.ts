...
@Component({
    selector: 'app-tour-listing-left-sidebar-page',
    imports: [RouterLink, PageBanner, NgStyle],
    templateUrl: './tour-listing-left-sidebar-page.html',
    styleUrl: './tour-listing-left-sidebar-page.scss',
})
export class TourListingLeftSidebarPage {
