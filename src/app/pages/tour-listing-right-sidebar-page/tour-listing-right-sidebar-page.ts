...
@Component({
    selector: 'app-tour-listing-right-sidebar-page',
    imports: [RouterLink, PageBanner, NgStyle, Overview],
    templateUrl: './tour-listing-right-sidebar-page.html',
    styleUrl: './tour-listing-right-sidebar-page.scss',
})
export class TourListingRightSidebarPage {
